...
const translations: TranslationMap = {
  ...
  "settings.subtitle": { vi: "Quản lý danh sách Category, Department và Campus dùng cho toàn bộ hệ thống", en: "Manage the Category, Department, and Campus lists used across the whole system" },
  ...
  "settings.departmentPlaceholder": { vi: "VD: Finance, HR, Admissions…", en: "e.g. Finance, HR, Admissions…" },
