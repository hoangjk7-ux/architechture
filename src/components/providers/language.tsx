...
const translations: TranslationMap = {
  ...
  "common.titleRequired": { vi: "Tiêu đề là bắt buộc", en: "Title is required" },
  ...
  "dashboard.subtitle": { vi: "Tổng quan quản trị công nghệ", en: "Technology governance overview" },
  ...
  "dashboard.avgArchitectureScore": { vi: "Điểm kiến trúc TB", en: "Avg Architecture Score" },
  "dashboard.avgTechnicalDebt": { vi: "Nợ kỹ thuật TB", en: "Avg Technical Debt" },
  "dashboard.expiringContracts": { vi: "Hợp đồng sắp hết hạn", en: "Expiring Contracts" },
  ...
  "dashboard.nonCompliantIntegrations": { vi: "tích hợp chưa tuân thủ kiến trúc", en: "integration(s) not architecture-compliant" },
  ...
  "dashboard.riskScoreAtLeast70": { vi: "Điểm rủi ro >= 70", en: "Risk score >= 70" },
  "dashboard.noVendors": { vi: "Chưa có nhà cung cấp nào.", en: "No vendors yet." },
  ...
  "systems.subtitleSuffix": { vi: "hệ thống được theo dõi trên toàn bộ campus", en: "systems tracked across all campuses" },
  ...
  "systems.searchPlaceholder": { vi: "Tìm theo tên hoặc danh mục…", en: "Search name or category…" },
  "systems.noSystemsFound": { vi: "Không tìm thấy hệ thống nào", en: "No systems found" },
  "systems.addFirstSystem": { vi: "Thêm hệ thống đầu tiên", en: "Add your first system" },
  "systems.stat.total": { vi: "Tổng số hệ thống", en: "Total Systems" },
  "systems.stat.totalSub": { vi: "trên toàn bộ campus", en: "across all campuses" },
  "systems.stat.critical": { vi: "Hệ thống trọng yếu", en: "Critical Systems" },
  "systems.stat.criticalSub": { vi: "mức độ trọng yếu cao", en: "high criticality" },
  "systems.stat.legacy": { vi: "Hệ thống cũ", en: "Legacy Systems" },
  "systems.stat.legacySub": { vi: "cần kế hoạch chuyển đổi", en: "require migration plan" },
  "systems.stat.noOwner": { vi: "Chưa có chủ sở hữu", en: "No Owner" },
  "systems.stat.noOwnerSub": { vi: "hệ thống chưa được gán", en: "unassigned systems" },
  "systems.stat.expiring": { vi: "Hết hạn trong 90 ngày", en: "Expiring 90d" },
  "systems.stat.expiringSub": { vi: "hợp đồng sắp hết hạn", en: "contracts ending soon" },
  ...
  "systems.form.namePlaceholder": { vi: "VD: Student CRM", en: "e.g. Student CRM" },
  ...
  "systems.form.technologyPlaceholder": { vi: "VD: Laravel, NodeJS", en: "e.g. Laravel, NodeJS" },
  "systems.form.database": { vi: "Cơ sở dữ liệu", en: "Database" },
  "systems.form.databasePlaceholder": { vi: "VD: MySQL, PostgreSQL", en: "e.g. MySQL, PostgreSQL" },
  "systems.form.hosting": { vi: "Lưu trữ", en: "Hosting" },
  "systems.form.hostingPlaceholder": { vi: "VD: AWS, On-premise", en: "e.g. AWS, On-premise" },
  ...
  "systems.form.licenseTypePlaceholder": { vi: "VD: Subscription", en: "e.g. Subscription" },
  "systems.form.costPerYear": { vi: "Chi phí / Năm (VNĐ)", en: "Cost / Year (VND)" },
  "systems.form.contractEndDate": { vi: "Ngày hết hạn hợp đồng", en: "Contract End Date" },
  "systems.form.riskLevel": { vi: "Mức rủi ro", en: "Risk Level" },
  "systems.form.technicalDebt": { vi: "Nợ kỹ thuật (0–100)", en: "Technical Debt (0–100)" },
  "systems.form.architectureScore": { vi: "Điểm kiến trúc (0–100)", en: "Architecture Score (0–100)" },
  ...
  "systems.form.descriptionPlaceholder": { vi: "Mô tả ngắn gọn...", en: "Brief description..." },
  ...
  "systems.activityLogTitle": { vi: "Nhật ký thay đổi hệ thống", en: "System Activity Log" },
  "systems.noLogs": { vi: "Chưa có thay đổi nào được ghi nhận", en: "No changes recorded yet" },
  ...
  "vendors.searchPlaceholder": { vi: "Tìm nhà cung cấp…", en: "Search vendors…" },
  "vendors.noVendorsFound": { vi: "Không tìm thấy nhà cung cấp nào", en: "No vendors found" },
  "vendors.addFirstVendor": { vi: "Thêm nhà cung cấp đầu tiên", en: "Add your first vendor" },
  ...
  "vendors.stat.expiringSub": { vi: "lên kế hoạch gia hạn", en: "plan renewal" },
  ...
  "vendors.filter.mediumRisk": { vi: "Trung bình (40–69)", en: "Medium (40–69)" },
  ...
  "vendors.form.namePlaceholder": { vi: "VD: OpenEdu Solutions", en: "e.g. OpenEdu Solutions" },
  ...
  "vendors.form.costPerYear": { vi: "Chi phí / Năm (VNĐ)", en: "Cost / Year (VND)" },
  "vendors.form.contractEndDate": { vi: "Ngày hết hạn hợp đồng", en: "Contract End Date" },
  "vendors.form.riskScore": { vi: "Điểm rủi ro (0–100) — cao hơn = rủi ro hơn", en: "Risk Score (0–100) — higher = riskier" },
  "vendors.form.notesPlaceholder": { vi: "Ghi chú thêm...", en: "Additional notes..." },
  "vendors.form.saveVendor": { vi: "Lưu nhà cung cấp", en: "Save Vendor" },
  "vendors.toast.added": { vi: "Đã thêm nhà cung cấp", en: "Vendor added" },
  "vendors.toast.updated": { vi: "Đã cập nhật nhà cung cấp", en: "Vendor updated" },
  "vendors.toast.removed": { vi: "Đã xoá nhà cung cấp", en: "Vendor removed" },

  // ─── Integrations page ───────────────────────────────────────────────────
  "integrations.title": { vi: "Quản trị Tích hợp", en: "Integration Governance" },
  "integrations.subtitleSuffix": { vi: "tích hợp được theo dõi", en: "integrations tracked" },
  "integrations.addIntegration": { vi: "Thêm tích hợp", en: "Add Integration" },
  "integrations.editIntegration": { vi: "Sửa tích hợp", en: "Edit Integration" },
  "integrations.noIntegrationsTracked": { vi: "Chưa có tích hợp nào được theo dõi", en: "No integrations tracked yet" },
  "integrations.col.integration": { vi: "Tích hợp", en: "Integration" },
  "integrations.col.sourceDestination": { vi: "Nguồn → Đích", en: "Source → Destination" },
  ...
  "integrations.form.namePlaceholder": { vi: "VD: Đồng bộ CRM sang ERP", en: "e.g. CRM to ERP Sync" },
  "integrations.form.source": { vi: "Hệ thống nguồn *", en: "Source System *" },
  "integrations.form.destination": { vi: "Hệ thống đích *", en: "Destination System *" },
  "integrations.form.selectSource": { vi: "Chọn hệ thống nguồn", en: "Select source" },
  "integrations.form.selectDestination": { vi: "Chọn hệ thống đích", en: "Select destination" },
  ...
  "integrations.form.criticalLevel": { vi: "Mức độ quan trọng", en: "Critical Level" },
  "integrations.form.owner": { vi: "Người phụ trách", en: "Owner" },
  "integrations.form.ownerPlaceholder": { vi: "VD: IT Team", en: "e.g. IT Team" },
  "integrations.form.errorRate": { vi: "Tỷ lệ lỗi (%)", en: "Error Rate (%)" },
  "integrations.form.lastSync": { vi: "Đồng bộ lần cuối", en: "Last Sync" },
  "integrations.form.architectureCompliant": { vi: "Tuân thủ kiến trúc", en: "Architecture Compliant" },
  "integrations.form.description": { vi: "Mô tả", en: "Description" },
  "integrations.form.descriptionPlaceholder": { vi: "Mô tả tích hợp này...", en: "Describe this integration..." },
  "integrations.toast.validation": { vi: "Cần nhập tên, nguồn và đích", en: "Name, source and destination are required" },
  "integrations.toast.added": { vi: "Đã thêm tích hợp", en: "Integration added" },
  ...
  "arch.noSystemsToDisplay": { vi: "Chưa có hệ thống nào để hiển thị", en: "No systems to display" },
  "arch.addSystemsFirst": { vi: "Thêm hệ thống trong Kho hệ thống trước", en: "Add systems in System Inventory first" },
  "arch.flow.systemType": { vi: "Loại hệ thống:", en: "System type:" },
  "arch.flow.edgeHealth": { vi: "Tình trạng liên kết:", en: "Edge health:" },
  "arch.flow.legendNote": { vi: "Độ dày = mức độ quan trọng · Mũi tên = hướng luồng", en: "Thickness = criticality · Arrows = flow direction" },
  "arch.flow.hint": { vi: "Nhấp vào hệ thống để làm nổi bật kết nối · Cuộn để phóng to · Kéo để di chuyển", en: "Click a system to highlight connections · Scroll to zoom · Drag to pan" },
  ...
  "arch.flow.noIntegrations": { vi: "Không có tích hợp", en: "No integrations" },
  "arch.gantt.title": { vi: "Dòng thời gian lộ trình", en: "Roadmap Timeline" },
  "arch.gantt.itemsWord": { vi: "mục", en: "items" },
  "arch.gantt.byDates": { vi: "xem theo lịch trình (Gantt)", en: "Gantt view by scheduled dates" },
  ...
  "dept.noDataTitle": { vi: "Chưa có dữ liệu phòng ban", en: "No department data yet" },
  "dept.noDataHint": { vi: "Thêm phòng ban trong trang Cấu hình", en: "Add departments in Settings" },
  "dept.noSystemsInDept": { vi: "Không có hệ thống nào trong phòng ban này", en: "No systems in this department" },
  "dept.critical": { vi: "trọng yếu", en: "critical" },
  "dept.portfolio": { vi: "Danh mục hệ thống", en: "System portfolio" },
  "dept.selectHint": { vi: "Chọn một phòng ban để xem chi tiết hệ thống, tích hợp và rủi ro vận hành.", en: "Select a department to inspect systems, integrations and operational risk." },
  ...
  "module.namePlaceholder": { vi: "VD: Student Portal", en: "e.g. Student Portal" },
  ...
  "module.usedByHint": { vi: "(phân tách bằng dấu phẩy)", en: "(comma separated)" },
  "module.usedByPlaceholder": { vi: "VD: Admissions, Finance", en: "e.g. Admissions, Finance" },
  ...
  "roadmap.editRoadmapItem": { vi: "Sửa mục lộ trình", en: "Edit Roadmap Item" },
  "roadmap.noItems": { vi: "Chưa có mục lộ trình nào", en: "No roadmap items yet" },
  ...
  "roadmap.form.titlePlaceholder": { vi: "VD: Sáng kiến Campus số", en: "e.g. Digital Campus Initiative" },
  ...
  "roadmap.form.alignmentScore": { vi: "Điểm phù hợp kiến trúc (0-100)", en: "Architecture Alignment Score (0-100)" },
  "roadmap.form.description": { vi: "Mô tả", en: "Description" },
  "roadmap.form.descriptionPlaceholder": { vi: "Mô tả mục lộ trình này...", en: "Describe this roadmap item..." },
  ...
  "settings.subtitle": { vi: "Quản lý danh mục, phòng ban và cơ sở dùng chung trong toàn hệ thống", en: "Manage the Category, Department, and Campus lists used across the whole system" },
  "settings.category": { vi: "Danh mục", en: "Category" },
  "settings.categoryPlaceholder": { vi: "VD: CRM, ERP, SIS…", en: "e.g. CRM, ERP, SIS…" },
  "settings.categoryDesc": { vi: "Phân loại chức năng của hệ thống phần mềm", en: "Functional classification of software systems" },
  "settings.department": { vi: "Phòng ban", en: "Department" },
  "settings.departmentPlaceholder": { vi: "VD: Tài chính, Nhân sự, Tuyển sinh…", en: "e.g. Finance, HR, Admissions…" },
  "settings.departmentDesc": { vi: "Các phòng ban sử dụng hệ thống", en: "Departments that use the systems" },
  "settings.campus": { vi: "Cơ sở", en: "Campus" },
  "settings.campusPlaceholder": { vi: "VD: Hà Nội, TP.HCM, Đà Nẵng…", en: "e.g. Hanoi, HCMC, Da Nang…" },
  "settings.campusDesc": { vi: "Cơ sở / chi nhánh áp dụng hệ thống", en: "Campuses / branches where systems apply" },
  "settings.noData": { vi: "Chưa có dữ liệu. Thêm mới bên dưới.", en: "No data yet. Add one below." },
  ...
  "settings.toast.updateFailed": { vi: "Không thể cập nhật", en: "Failed to update" },
  "settings.toast.removeFailed": { vi: "Không thể xoá", en: "Failed to remove" },

  // ─── Users page ──────────────────────────────────────────────────────────
  "users.title": { vi: "Người dùng & Phân quyền", en: "Users & Roles" },
  "users.subtitle": { vi: "Quản lý quyền truy cập cho từng thành viên", en: "Manage access permissions for each member" },
  "users.addUser": { vi: "Thêm người dùng", en: "Add User" },
  "users.ctoOnly": { vi: "Chỉ CTO mới có thể quản lý người dùng và phân quyền.", en: "Only the CTO can manage users and roles." },
  ...
  "users.invite.emailPlaceholder": { vi: "user@school.edu.vn", en: "user@school.edu" },
  "users.invite.role": { vi: "Phân quyền", en: "Role" },
  "users.invite.hint": { vi: "Người dùng sẽ được cấp quyền khi đăng nhập lần đầu bằng email này.", en: "The user will be granted this role the first time they sign in with this email." },
  "users.toast.emailRequired": { vi: "Email là bắt buộc", en: "Email is required" },
  "users.toast.emailInvalid": { vi: "Email không hợp lệ", en: "Invalid email" },
  "users.toast.userAdded": { vi: "Đã thêm người dùng", en: "User added" },
  "users.toast.userAddFailed": { vi: "Không thể thêm người dùng", en: "Failed to add user" },
  "users.toast.roleUpdated": { vi: "Đã cập nhật phân quyền", en: "Role updated" },
  "users.toast.roleUpdateFailed": { vi: "Không thể cập nhật phân quyền", en: "Failed to update role" },
  "users.toast.userRemoved": { vi: "Đã xoá người dùng", en: "User removed" },
  "users.toast.userRemoveFailed": { vi: "Không thể xoá người dùng", en: "Failed to remove user" },
  ...
  "role.desc.cto": { vi: "Toàn quyền truy cập tất cả module", en: "Full access to all modules" },
  "role.desc.itManager": { vi: "Đọc/ghi tất cả, ngoại trừ Users", en: "Read/write everything except Users" },
  "role.desc.businessOwner": { vi: "Xem systems, vendors, roadmap", en: "View systems, vendors, roadmap" },
